...
def setting(args):
    ...
    if args.dataset == 'nih-14':
        args.data_root_img = '/data2/local_datasets/www_data/nih_chest_x-rays/imgs' #
        if not os.path.exists(args.data_root_img):
            args.data_root_img = '/local_datasets/www_data/nih_chest_x-rays/imgs' #
        # if args.split == 'train':
        #     args.split_path = f'{PROJECT}/dataset/annotation/nih_split/train_official.txt'
        # elif args.split == 'val':
        #     args.split_path = f'{PROJECT}/dataset/annotation/nih_split/val_official.txt'
        # elif args.split == 'test':
        #     args.split_path = f'{PROJECT}/dataset/annotation/nih_split/test_official.txt'
        if args.split == 'train':
